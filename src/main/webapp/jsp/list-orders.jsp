...
<div class="container">
    ...
    <div class="container-table">
                ...
                <ul class="dropdown-menu">
                    <c:choose>
                        <c:when test="${modifyAvailable[loop.index]}">
                            <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#orderModal${after.id}">Edit</a>
                            </li>
        ...
        <!-- Modal for DELETE -->
        <div class="modal fade" id="deleteModal${after.id}" tabindex="-1" aria-labelledby="deleteModalLabel${after.id}"
             aria-hidden="true">
        ...
        <!-- Modal -->
        <div class="modal fade" id="orderModal${after.id}" tabindex="-1" aria-labelledby="orderModalLabel${after.id}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="orderForm${after.id}" action="/wacar/order/update/${after.id}" method="post">
                            ...
                            <button id="confirmButton${after.id}" type="submit" class="btn btn-primary w-100">Confirm
                                changes
                            </button>
                        </form>
                    </div>
