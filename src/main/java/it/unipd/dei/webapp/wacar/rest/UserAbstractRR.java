 ...
 * @since 1.00
 */
public abstract class UserAbstractRR implements RestResource {
	 ...
	 */
	protected UserAbstractRR(final String action, final HttpServletRequest req, final HttpServletResponse res, final Connection con) {
